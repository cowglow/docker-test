...
get you started. [About the JavaScript](doc/js.md).
...
[Read more about the `.editorconfig` file](doc/misc.md#editorconfig).
...
refer to the [according documentation](doc/extend.md#apple-touch-icons).
